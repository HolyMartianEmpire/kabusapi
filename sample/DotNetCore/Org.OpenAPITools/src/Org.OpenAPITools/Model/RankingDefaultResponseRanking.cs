...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RankingDefaultResponse_Ranking")]
    public partial class RankingDefaultResponseRanking : IEquatable<RankingDefaultResponseRanking>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RankingDefaultResponseRanking" /> class.
        /// </summary>
        ...
        public RankingDefaultResponseRanking(int no = default(int), string trend = default(string), double averageRanking = default(double), string symbol = default(string), string symbolName = default(string), double currentPrice = default(double), double changeRatio = default(double), double changePercentage = default(double), string currentPriceTime = default(string), double tradingVolume = default(double), double turnover = default(double), string exchangeName = default(string), string categoryName = default(string))
        {
            this.No = no;
            this.Trend = trend;
        ...
        {
            return this.Equals(input as RankingDefaultResponseRanking);
        }

        /// <summary>
        /// Returns true if RankingDefaultResponseRanking instances are equal
        /// </summary>
        /// <param name="input">Instance of RankingDefaultResponseRanking to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RankingDefaultResponseRanking input)
        {
            if (input == null)
                return false;
