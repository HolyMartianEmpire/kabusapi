...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class WalletMarginSuccess : IEquatable<WalletMarginSuccess>, IValidatableObject
    {
        ...
        /// <param name="consignmentDepositRate">委託保証金率&lt;br&gt;※銘柄指定の場合のみ。&lt;br&gt;※銘柄が指定されなかった場合、空を返す。.</param>
        /// <param name="cashOfConsignmentDepositRate">現金委託保証金率&lt;br&gt;※銘柄指定の場合のみ。&lt;br&gt;※銘柄が指定されなかった場合、空を返す。.</param>
        ...
        /// <summary>
        /// 委託保証金率&lt;br&gt;※銘柄指定の場合のみ。&lt;br&gt;※銘柄が指定されなかった場合、空を返す。
        /// </summary>
        /// <value>委託保証金率&lt;br&gt;※銘柄指定の場合のみ。&lt;br&gt;※銘柄が指定されなかった場合、空を返す。</value>
        [DataMember(Name = "ConsignmentDepositRate", EmitDefaultValue = true)]
        public double ConsignmentDepositRate { get; set; }

        /// <summary>
        /// 現金委託保証金率&lt;br&gt;※銘柄指定の場合のみ。&lt;br&gt;※銘柄が指定されなかった場合、空を返す。
        /// </summary>
        /// <value>現金委託保証金率&lt;br&gt;※銘柄指定の場合のみ。&lt;br&gt;※銘柄が指定されなかった場合、空を返す。</value>
