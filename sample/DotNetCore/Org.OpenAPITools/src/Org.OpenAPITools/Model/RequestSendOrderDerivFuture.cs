...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RequestSendOrderDerivFuture")]
    public partial class RequestSendOrderDerivFuture : IEquatable<RequestSendOrderDerivFuture>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestSendOrderDerivFuture" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RequestSendOrderDerivFuture() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestSendOrderDerivFuture" /> class.
        /// </summary>
        /// <param name="password">注文パスワード (required).</param>
        /// <param name="symbol">銘柄コード&lt;br&gt;※取引最終日に「先物銘柄コード取得」でDerivMonthに0（直近限月）を指定した場合、日中・夜間の時間帯に関わらず、取引最終日を迎える限月の銘柄コードを返します。取引最終日を迎える銘柄の取引は日中取引をもって終了となりますので、ご注意ください。 (required).</param>
        ...
        public RequestSendOrderDerivFuture(string password = default(string), string symbol = default(string), int exchange = default(int), int tradeType = default(int), int timeInForce = default(int), string side = default(string), int qty = default(int), int closePositionOrder = default(int), List<PositionsDeriv> closePositions = default(List<PositionsDeriv>), int frontOrderType = default(int), int price = default(int), int expireDay = default(int))
        {
            // to ensure "password" is required (not null)
            this.Password = password ?? throw new ArgumentNullException("password is a required property for RequestSendOrderDerivFuture and cannot be null");
            // to ensure "symbol" is required (not null)
            this.Symbol = symbol ?? throw new ArgumentNullException("symbol is a required property for RequestSendOrderDerivFuture and cannot be null");
            this.Exchange = exchange;
            this.TradeType = tradeType;
            this.TimeInForce = timeInForce;
            // to ensure "side" is required (not null)
            this.Side = side ?? throw new ArgumentNullException("side is a required property for RequestSendOrderDerivFuture and cannot be null");
            this.Qty = qty;
        ...
        /// </summary>
        /// <value>銘柄コード&lt;br&gt;※取引最終日に「先物銘柄コード取得」でDerivMonthに0（直近限月）を指定した場合、日中・夜間の時間帯に関わらず、取引最終日を迎える限月の銘柄コードを返します。取引最終日を迎える銘柄の取引は日中取引をもって終了となりますので、ご注意ください。</value>
        ...
        {
            return this.Equals(input as RequestSendOrderDerivFuture);
        }

        /// <summary>
        /// Returns true if RequestSendOrderDerivFuture instances are equal
        /// </summary>
        /// <param name="input">Instance of RequestSendOrderDerivFuture to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequestSendOrderDerivFuture input)
        {
            if (input == null)
                return false;
