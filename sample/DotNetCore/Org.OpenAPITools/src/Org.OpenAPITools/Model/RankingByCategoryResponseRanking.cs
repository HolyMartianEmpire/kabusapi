...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class RankingByCategoryResponseRanking : IEquatable<RankingByCategoryResponseRanking>, IValidatableObject
    {
        ...
        public RankingByCategoryResponseRanking(int no = default(int), string trend = default(string), decimal averageRanking = default(decimal), string category = default(string), string categoryName = default(string), double currentPrice = default(double), double changeRatio = default(double), string currentPriceTime = default(string), double changePercentage = default(double))
        {
            this.No = no;
            this.Trend = trend;
