...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RankingByTradeValueResponse")]
    public partial class RankingByTradeValueResponse : IEquatable<RankingByTradeValueResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RankingByTradeValueResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as RankingByTradeValueResponse);
        }

        /// <summary>
        /// Returns true if RankingByTradeValueResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RankingByTradeValueResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RankingByTradeValueResponse input)
        {
            if (input == null)
                return false;
