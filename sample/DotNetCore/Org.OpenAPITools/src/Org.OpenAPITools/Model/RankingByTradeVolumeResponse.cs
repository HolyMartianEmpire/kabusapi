...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class RankingByTradeVolumeResponse : IEquatable<RankingByTradeVolumeResponse>, IValidatableObject
    {
        ...
        public RankingByTradeVolumeResponse(string type = default(string), string exchangeDivision = default(string), List<CommonRankingItems> ranking = default(List<CommonRankingItems>))
        {
            this.Type = type;
