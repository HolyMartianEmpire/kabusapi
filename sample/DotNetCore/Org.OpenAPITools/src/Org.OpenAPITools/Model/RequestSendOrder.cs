...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class RequestSendOrder : IEquatable<RequestSendOrder>, IValidatableObject
    {
        ...
        /// <param name="cashMargin">信用区分 |定義値|説明| |-|-| |1|現物| |2|新規| |3|返済| (required).</param>
        /// <param name="marginTradeType">信用取引区分&lt;br&gt;※現物取引の場合は指定不要。&lt;br&gt;※信用取引の場合、必須。 |定義値|説明| |-|-| |1|制度信用| |2|一般信用| |3|一般信用（売短）|.</param>
        ...
        /// <param name="fundType">資産区分&lt;br&gt;※現物買は、指定必須。&lt;br&gt;※現物売は、「&#39;  &#39;」 半角スペース2つを指定必須。&lt;br&gt;※信用新規と信用返済は、指定不要。 |定義値|説明| |-|-| |(半角スペース2つ)|現物売の場合| |02|保護| |AA|信用代用| |11|信用取引|.</param>
        ...
        /// <param name="closePositionOrder">決済順序&lt;br&gt;※信用取引の場合、必須。&lt;br&gt;※ClosePositionOrderとClosePositionsはどちらか一方のみ指定可能。&lt;br&gt;※ClosePositionOrderとClosePositionsを両方指定した場合、エラー。 |定義値|説明| |-|-| |0|日付（古い順）、損益（高い順）| |1|日付（古い順）、損益（低い順）| |2|日付（新しい順）、損益（高い順）| |3|日付（新しい順）、損益（低い順）| |4|損益（高い順）、日付（古い順）| |5|損益（高い順）、日付（新しい順）| |6|損益（低い順）、日付（古い順）| |7|損益（低い順）、日付（新しい順）|.</param>
        /// <param name="closePositions">返済建玉指定&lt;br&gt;※信用取引の場合、必須。&lt;br&gt;※ClosePositionOrderとClosePositionsはどちらか一方のみ指定可能。&lt;br&gt;※ClosePositionOrderとClosePositionsを両方指定した場合、エラー。&lt;br&gt;※信用一括返済の場合、各建玉IDと返済したい数量を入力してください。&lt;br&gt;※建玉IDは「E」から始まる番号です。.</param>
        /// <param name="frontOrderType">執行条件&lt;br&gt; |定義値|説明|”Price\&quot;の指定| |-|-|-| |10|成行|0| |13|寄成（前場）|0| |14|寄成（後場）|0| |15|引成（前場）|0| |16|引成（後場）|0| |17|IOC成行|0| |20|指値|発注したい金額| |21|寄指（前場）|発注したい金額| |22|寄指（後場）|発注したい金額| |23|引指（前場）|発注したい金額| |24|引指（後場）|発注したい金額| |25|不成（前場）|発注したい金額| |26|不成（後場）|発注したい金額| |27|IOC指値|発注したい金額| (required).</param>
        ...
        /// <summary>
        /// 信用区分 |定義値|説明| |-|-| |1|現物| |2|新規| |3|返済|
        /// </summary>
        /// <value>信用区分 |定義値|説明| |-|-| |1|現物| |2|新規| |3|返済|</value>
        [DataMember(Name = "CashMargin", IsRequired = true, EmitDefaultValue = true)]
        public int CashMargin { get; set; }

        /// <summary>
        /// 信用取引区分&lt;br&gt;※現物取引の場合は指定不要。&lt;br&gt;※信用取引の場合、必須。 |定義値|説明| |-|-| |1|制度信用| |2|一般信用| |3|一般信用（売短）|
        /// </summary>
        /// <value>信用取引区分&lt;br&gt;※現物取引の場合は指定不要。&lt;br&gt;※信用取引の場合、必須。 |定義値|説明| |-|-| |1|制度信用| |2|一般信用| |3|一般信用（売短）|</value>
        ...
        /// <summary>
        /// 資産区分&lt;br&gt;※現物買は、指定必須。&lt;br&gt;※現物売は、「&#39;  &#39;」 半角スペース2つを指定必須。&lt;br&gt;※信用新規と信用返済は、指定不要。 |定義値|説明| |-|-| |(半角スペース2つ)|現物売の場合| |02|保護| |AA|信用代用| |11|信用取引|
        /// </summary>
        /// <value>資産区分&lt;br&gt;※現物買は、指定必須。&lt;br&gt;※現物売は、「&#39;  &#39;」 半角スペース2つを指定必須。&lt;br&gt;※信用新規と信用返済は、指定不要。 |定義値|説明| |-|-| |(半角スペース2つ)|現物売の場合| |02|保護| |AA|信用代用| |11|信用取引|</value>
        ...
        /// <summary>
        /// 決済順序&lt;br&gt;※信用取引の場合、必須。&lt;br&gt;※ClosePositionOrderとClosePositionsはどちらか一方のみ指定可能。&lt;br&gt;※ClosePositionOrderとClosePositionsを両方指定した場合、エラー。 |定義値|説明| |-|-| |0|日付（古い順）、損益（高い順）| |1|日付（古い順）、損益（低い順）| |2|日付（新しい順）、損益（高い順）| |3|日付（新しい順）、損益（低い順）| |4|損益（高い順）、日付（古い順）| |5|損益（高い順）、日付（新しい順）| |6|損益（低い順）、日付（古い順）| |7|損益（低い順）、日付（新しい順）|
        /// </summary>
        /// <value>決済順序&lt;br&gt;※信用取引の場合、必須。&lt;br&gt;※ClosePositionOrderとClosePositionsはどちらか一方のみ指定可能。&lt;br&gt;※ClosePositionOrderとClosePositionsを両方指定した場合、エラー。 |定義値|説明| |-|-| |0|日付（古い順）、損益（高い順）| |1|日付（古い順）、損益（低い順）| |2|日付（新しい順）、損益（高い順）| |3|日付（新しい順）、損益（低い順）| |4|損益（高い順）、日付（古い順）| |5|損益（高い順）、日付（新しい順）| |6|損益（低い順）、日付（古い順）| |7|損益（低い順）、日付（新しい順）|</value>
        [DataMember(Name = "ClosePositionOrder", EmitDefaultValue = true)]
        public int ClosePositionOrder { get; set; }

        /// <summary>
        /// 返済建玉指定&lt;br&gt;※信用取引の場合、必須。&lt;br&gt;※ClosePositionOrderとClosePositionsはどちらか一方のみ指定可能。&lt;br&gt;※ClosePositionOrderとClosePositionsを両方指定した場合、エラー。&lt;br&gt;※信用一括返済の場合、各建玉IDと返済したい数量を入力してください。&lt;br&gt;※建玉IDは「E」から始まる番号です。
        /// </summary>
        /// <value>返済建玉指定&lt;br&gt;※信用取引の場合、必須。&lt;br&gt;※ClosePositionOrderとClosePositionsはどちらか一方のみ指定可能。&lt;br&gt;※ClosePositionOrderとClosePositionsを両方指定した場合、エラー。&lt;br&gt;※信用一括返済の場合、各建玉IDと返済したい数量を入力してください。&lt;br&gt;※建玉IDは「E」から始まる番号です。</value>
        [DataMember(Name = "ClosePositions", EmitDefaultValue = true)]
        public List<Positions> ClosePositions { get; set; }

        /// <summary>
        /// 執行条件&lt;br&gt; |定義値|説明|”Price\&quot;の指定| |-|-|-| |10|成行|0| |13|寄成（前場）|0| |14|寄成（後場）|0| |15|引成（前場）|0| |16|引成（後場）|0| |17|IOC成行|0| |20|指値|発注したい金額| |21|寄指（前場）|発注したい金額| |22|寄指（後場）|発注したい金額| |23|引指（前場）|発注したい金額| |24|引指（後場）|発注したい金額| |25|不成（前場）|発注したい金額| |26|不成（後場）|発注したい金額| |27|IOC指値|発注したい金額|
        /// </summary>
        /// <value>執行条件&lt;br&gt; |定義値|説明|”Price\&quot;の指定| |-|-|-| |10|成行|0| |13|寄成（前場）|0| |14|寄成（後場）|0| |15|引成（前場）|0| |16|引成（後場）|0| |17|IOC成行|0| |20|指値|発注したい金額| |21|寄指（前場）|発注したい金額| |22|寄指（後場）|発注したい金額| |23|引指（前場）|発注したい金額| |24|引指（後場）|発注したい金額| |25|不成（前場）|発注したい金額| |26|不成（後場）|発注したい金額| |27|IOC指値|発注したい金額|</value>
