...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RankingDefaultResponse")]
    public partial class RankingDefaultResponse : IEquatable<RankingDefaultResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RankingDefaultResponse" /> class.
        /// </summary>
        /// <param name="type">種別.</param>
        /// <param name="exchangeDivision">市場.</param>
        /// <param name="ranking">ランキング.</param>
        public RankingDefaultResponse(string type = default(string), string exchangeDivision = default(string), List<RankingDefaultResponseRanking> ranking = default(List<RankingDefaultResponseRanking>))
        {
            this.Type = type;
        ...
        public List<RankingDefaultResponseRanking> Ranking { get; set; }
        ...
        {
            return this.Equals(input as RankingDefaultResponse);
        }

        /// <summary>
        /// Returns true if RankingDefaultResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RankingDefaultResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RankingDefaultResponse input)
        {
            if (input == null)
                return false;
