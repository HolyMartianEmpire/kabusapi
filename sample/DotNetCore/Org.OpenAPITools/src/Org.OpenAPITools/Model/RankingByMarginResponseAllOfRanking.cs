...
{
    /// <summary>
    /// RankingByMarginResponseAllOfRanking
    /// </summary>
    [DataContract(Name = "RankingByMarginResponse_allOf_Ranking")]
    public partial class RankingByMarginResponseAllOfRanking : IEquatable<RankingByMarginResponseAllOfRanking>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RankingByMarginResponseAllOfRanking" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RankingByMarginResponseAllOfRanking {\n");
        ...
        {
            return this.Equals(input as RankingByMarginResponseAllOfRanking);
        }

        /// <summary>
        /// Returns true if RankingByMarginResponseAllOfRanking instances are equal
        /// </summary>
        /// <param name="input">Instance of RankingByMarginResponseAllOfRanking to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RankingByMarginResponseAllOfRanking input)
        {
            if (input == null)
                return false;
