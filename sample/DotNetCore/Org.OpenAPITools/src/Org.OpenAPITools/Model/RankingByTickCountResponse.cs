...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class RankingByTickCountResponse : IEquatable<RankingByTickCountResponse>, IValidatableObject
    {
        ...
        public RankingByTickCountResponse(string type = default(string), string exchangeDivision = default(string), List<CommonRankingItems> ranking = default(List<CommonRankingItems>))
        {
            this.Type = type;
