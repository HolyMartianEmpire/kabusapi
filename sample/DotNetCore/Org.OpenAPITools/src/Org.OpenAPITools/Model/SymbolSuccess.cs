...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SymbolSuccess : IEquatable<SymbolSuccess>, IValidatableObject
    {
        ...
        /// <param name="totalMarketValue">時価総額&lt;br&gt;※株式銘柄の場合のみ&lt;br&gt;追加情報出力フラグ：falseの場合、null.</param>
        /// <param name="totalStocks">発行済み株式数（千株）&lt;br&gt;※株式銘柄の場合のみ&lt;br&gt;追加情報出力フラグ：falseの場合、null.</param>
        /// <param name="tradingUnit">売買単位&lt;br&gt;※株式・先物・オプション銘柄の場合のみ.</param>
        /// <param name="fiscalYearEndBasic">決算期日&lt;br&gt;※株式銘柄の場合のみ&lt;br&gt;追加情報出力フラグ：falseの場合、null.</param>
        ...
        /// <param name="clearingPrice">清算値&lt;br&gt;※先物銘柄の場合のみ&lt;br&gt;追加情報出力フラグ：falseの場合、null.</param>
        ...
        /// </summary>
        /// <value>時価総額&lt;br&gt;※株式銘柄の場合のみ&lt;br&gt;追加情報出力フラグ：falseの場合、null</value>
        ...
        /// </summary>
        /// <value>発行済み株式数（千株）&lt;br&gt;※株式銘柄の場合のみ&lt;br&gt;追加情報出力フラグ：falseの場合、null</value>
        ...
        /// </summary>
        /// <value>決算期日&lt;br&gt;※株式銘柄の場合のみ&lt;br&gt;追加情報出力フラグ：falseの場合、null</value>
        ...
        /// </summary>
        /// <value>清算値&lt;br&gt;※先物銘柄の場合のみ&lt;br&gt;追加情報出力フラグ：falseの場合、null</value>
