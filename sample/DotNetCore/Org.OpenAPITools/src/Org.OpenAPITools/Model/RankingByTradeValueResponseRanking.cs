...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RankingByTradeValueResponse_Ranking")]
    public partial class RankingByTradeValueResponseRanking : IEquatable<RankingByTradeValueResponseRanking>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RankingByTradeValueResponseRanking" /> class.
        /// </summary>
        ...
        /// <param name="rapidPaymentPercentage">代金急増（％）.</param>
        ...
        public RankingByTradeValueResponseRanking(int no = default(int), string trend = default(string), double averageRanking = default(double), string symbol = default(string), string symbolName = default(string), double currentPrice = default(double), double changeRatio = default(double), double rapidPaymentPercentage = default(double), double turnover = default(double), string currentPriceTime = default(string), double changePercentage = default(double), string exchangeName = default(string), string categoryName = default(string))
        {
            this.No = no;
            this.Trend = trend;
        ...
        /// </summary>
        /// <value>代金急増（％）</value>
        [DataMember(Name = "RapidPaymentPercentage", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RapidPaymentPercentage: ").Append(RapidPaymentPercentage).Append("\n");
        ...
        {
            return this.Equals(input as RankingByTradeValueResponseRanking);
        }

        /// <summary>
        /// Returns true if RankingByTradeValueResponseRanking instances are equal
        /// </summary>
        /// <param name="input">Instance of RankingByTradeValueResponseRanking to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RankingByTradeValueResponseRanking input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.RapidPaymentPercentage == input.RapidPaymentPercentage ||
                    this.RapidPaymentPercentage.Equals(input.RapidPaymentPercentage)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.RapidPaymentPercentage.GetHashCode();
