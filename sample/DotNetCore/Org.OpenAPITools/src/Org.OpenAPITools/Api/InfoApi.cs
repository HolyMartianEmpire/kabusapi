...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IInfoApiSync : IApiAccessor
    {
        ...
        /// <param name="exchange">市場コード |定義値|説明| |-|-| |1|東証| |3|名証| |5|福証| |6|札証| |2|日通し| |23|日中| |24|夜間|</param>
        ...
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="X_API_KEY">トークン発行メソッドで取得した文字列</param>
        /// <param name="product">取得する商品 |定義値|説明| |-|-| |0|すべて| |1|現物| |2|信用| |3|先物| |4|OP| (optional)</param>
        ...
        /// <param name="details">注文詳細抑止 |定義値|説明| |-|-| |true|注文詳細を出力する（デフォルト）| |false|注文詳細の出力しない| (optional)</param>
        /// <param name="symbol">銘柄コード&lt;br&gt;※指定された銘柄コードと一致する注文のみレスポンスします。&lt;br&gt;※複数の銘柄コードを指定することができません。 (optional)</param>
        /// <param name="state">状態 &lt;br&gt;※指定された状態と一致する注文のみレスポンスします。&lt;br&gt;※フィルタには数字の入力のみ受け付けます。&lt;br&gt;※複数の状態を指定することはできません。 |定義値|説明| |-|-| |1|待機（発注待機）| |2|処理中（発注送信中）| |3|処理済（発注済・訂正済）| |4|訂正取消送信中| |5|終了（発注エラー・取消済・全約定・失効・期限切れ）| (optional)</param>
        /// <param name="side">売買区分 &lt;br&gt;※指定された売買区分と一致する注文のみレスポンスします。&lt;br&gt;※フィルタには数字の入力のみ受け付けます。&lt;br&gt;※複数の売買区分を指定することができません。 |定義値|説明| |-|-| |1|売| |2|買| (optional)</param>
        /// <param name="cashmargin">取引区分 &lt;br&gt;※指定された取引区分と一致する注文のみレスポンスします。&lt;br&gt;※フィルタには数字の入力のみ受け付けます。&lt;br&gt;※複数の取引区分を指定することができません。 |定義値|説明| |-|-| |2|新規| |3|返済| (optional)</param>
        ...
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="X_API_KEY">トークン発行メソッドで取得した文字列</param>
        /// <param name="futureCode">先物コード&lt;br&gt;※大文字小文字は区別しません。 |定義値|説明| |-|-| |NK225|日経平均先物| |NK225mini|日経225mini先物| |TOPIX|TOPIX先物| |TOPIXmini|ミニTOPIX先物| |MOTHERS|東証マザーズ先物| |JPX400|JPX日経400先物| |DOW|NYダウ先物| |VI|日経平均VI先物| |Core30|TOPIX Core30先物| |REIT|東証REIT指数先物|</param>
        ...
        ApiResponse<SymbolNameSuccess> SymbolnameFutureGetWithHttpInfo(string X_API_KEY, string futureCode, int derivMonth);
        /// <summary>
        /// オプション銘柄コード取得
        /// </summary>
        /// <remarks>
        ...
        /// <param name="X_API_KEY">トークン発行メソッドで取得した文字列</param>
        /// <param name="derivMonth">限月&lt;br&gt;※限月はyyyyMM形式で指定します。0を指定した場合、直近限月となります。&lt;br&gt;※取引最終日に「0」（直近限月）を指定した場合、日中・夜間の時間帯に関わらず、取引最終日を迎える限月の銘柄コードを返します。取引最終日を迎える銘柄の取引は日中取引をもって終了となりますので、ご注意ください。</param>
        /// <param name="putOrCall">コール or プット&lt;br&gt;※大文字小文字は区別しません。 |定義値|説明| |-|-| |P|PUT| |C|CALL|</param>
    ...
    public interface IInfoApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<SymbolNameSuccess> SymbolnameFutureGetAsync(string X_API_KEY, string futureCode, int derivMonth, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<SymbolNameSuccess>> SymbolnameFutureGetWithHttpInfoAsync(string X_API_KEY, string futureCode, int derivMonth, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// オプション銘柄コード取得
        /// </summary>
        /// <remarks>
    ...
    public partial class InfoApi : IInfoApi
    {
        ...
        /// <param name="derivMonth">限月&lt;br&gt;※限月はyyyyMM形式で指定します。0を指定した場合、直近限月となります。&lt;br&gt;※取引最終日に「0」（直近限月）を指定した場合、日中・夜間の時間帯に関わらず、取引最終日を迎える限月の銘柄コードを返します。取引最終日を迎える銘柄の取引は日中取引をもって終了となりますので、ご注意ください。</param>
        /// <returns>SymbolNameSuccess</returns>
        public SymbolNameSuccess SymbolnameFutureGet(string X_API_KEY, string futureCode, int derivMonth)
        {
            Org.OpenAPITools.Client.ApiResponse<SymbolNameSuccess> localVarResponse = SymbolnameFutureGetWithHttpInfo(X_API_KEY, futureCode, derivMonth);
            return localVarResponse.Data;
        }
        ...
        /// <param name="derivMonth">限月&lt;br&gt;※限月はyyyyMM形式で指定します。0を指定した場合、直近限月となります。&lt;br&gt;※取引最終日に「0」（直近限月）を指定した場合、日中・夜間の時間帯に関わらず、取引最終日を迎える限月の銘柄コードを返します。取引最終日を迎える銘柄の取引は日中取引をもって終了となりますので、ご注意ください。</param>
        /// <returns>ApiResponse of SymbolNameSuccess</returns>
        public Org.OpenAPITools.Client.ApiResponse<SymbolNameSuccess> SymbolnameFutureGetWithHttpInfo(string X_API_KEY, string futureCode, int derivMonth)
        {
            // verify the required parameter 'X_API_KEY' is set
            if (X_API_KEY == null)
            ...
            if (futureCode == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'futureCode' when calling InfoApi->SymbolnameFutureGet");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SymbolNameSuccess</returns>
        public async System.Threading.Tasks.Task<SymbolNameSuccess> SymbolnameFutureGetAsync(string X_API_KEY, string futureCode, int derivMonth, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Org.OpenAPITools.Client.ApiResponse<SymbolNameSuccess> localVarResponse = await SymbolnameFutureGetWithHttpInfoAsync(X_API_KEY, futureCode, derivMonth, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SymbolNameSuccess)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<SymbolNameSuccess>> SymbolnameFutureGetWithHttpInfoAsync(string X_API_KEY, string futureCode, int derivMonth, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'X_API_KEY' is set
            if (X_API_KEY == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'X_API_KEY' when calling InfoApi->SymbolnameFutureGet");
